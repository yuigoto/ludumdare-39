...
global.P1_KEY_ACTION1 = ini_read_real(section, "kb_action1", ord("Y"));
global.P1_KEY_ACTION2 = ini_read_real(section, "kb_action2", ord("U"));
global.P1_KEY_ACTION3 = ini_read_real(section, "kb_action3", ord("I"));
global.P1_KEY_ACTION4 = ini_read_real(section, "kb_action4", ord("O"));
