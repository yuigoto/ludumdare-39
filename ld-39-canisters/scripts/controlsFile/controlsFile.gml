...
for (var i = 1; i <= 4; i++) {
    ...
    switch (i) {
        case 1:
            ...
            ini_write_real(section, "kb_action1", ord("Y"));
            ini_write_real(section, "kb_action2", ord("U"));
            ini_write_real(section, "kb_action3", ord("I"));
            ini_write_real(section, "kb_action4", ord("O"));
